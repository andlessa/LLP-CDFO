...
def computeULs(inputFile,outputFile):
    ...
    # ### Load ATLAS data
    atlasFile = './ATLAS_data/modelIndependentLimits_HL.pcl'
    ...
    allDF['robs'] = allDF['$N_s$']*(lumi/allDF['Luminosity (1/fb)'])/allDF['S95_obs_HL']
    allDF['rexp'] = allDF['$N_s$']*(lumi/allDF['Luminosity (1/fb)'])/allDF['S95_exp_HL']
    allDF['robsErr'] = allDF['$\\sigma_{Ns}$']*(lumi/allDF['Luminosity (1/fb)'])/allDF['S95_obs_HL']
    allDF['rexpErr'] = allDF['$\\sigma_{Ns}$']*(lumi/allDF['Luminosity (1/fb)'])/allDF['S95_exp_HL']
