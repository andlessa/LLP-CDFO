{{{d[{i1, 1}], d[{i2, col2}]}, 
 ...
 {{e[{i1}], e[{i2}]}, (3*g1^2*Xi*Kronecker[i1, i2])/5 + 
   MatMul[Ye, Adj[Ye]][i1, i2], (-846*g1^4*Kronecker[i1, i2] - 
    15*(11*g1^2 - 85*g2^2 + 60*trace[Yd, Adj[Yd]] + 20*trace[Ye, Adj[Ye]])*
     MatMul[Ye, Adj[Ye]][i1, i2] - 50*MatMul[Ye, Adj[Ye], Ye, Adj[Ye]][i1, 
 ...
 {{l[{1}][{i1}], l[{lef2}][{i2}]}, 
  (3*(g1^2 + 5*g2^2)*Xi*Kronecker[1, lef2]*Kronecker[i1, i2])/20 + 
   MatMul[Tp[Ye], conj[Ye]][i1, i2]/2, 
  (-6*(11*g1^2 + 35*g2^2)*MatMul[Tp[Ye], conj[Ye]][i1, i2] - 
    ...
    40*MatMul[Tp[Ye], conj[Ye], Tp[Ye], conj[Ye]][i1, i2])/160}, 
